...
STRUCTURES_NEED_RAMPART = [STRUCTURE_SPAWN, STRUCTURE_TOWER, STRUCTURE_STORAGE]
STRUCTURES_NEED_CONSTRUCT = [STRUCTURE_SPAWN, STRUCTURE_TOWER, STRUCTURE_EXTENSION, STRUCTURE_STORAGE]
